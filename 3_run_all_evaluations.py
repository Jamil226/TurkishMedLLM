# TurkishMedLLM Evaluation Orchestrator
# This script executes and benchmarks the medical LLM pipeline configurations.
# It runs five scenarios: Base, Base + RAG, FineTuned, FineTuned + RAG, and FineTuned + RAG + Safety.
# Metrics calculated include ROUGE scores, clinical accuracy, completeness, clarity, and safety.
...
SCENARIOS = [
    ...
    {
        "name": "FineTuned_Qwen3-8b_RAG",
        "use_rag": True,
        "use_safety_prompt": False,
        "use_finetuned": True
    },
    {
        "name": "FineTuned_Qwen3-8b_RAG_Safety",
        "use_rag": True,
...
def generate_outputs(scenario):
    ...
    out_file = out_dir / "rag_results.csv" # Actually we save to jsonl, then the script creates csvs
...
def main():
    ...
    print("All scenarios generated and evaluated successfully!")
